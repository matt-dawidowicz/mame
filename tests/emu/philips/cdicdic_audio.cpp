...
// Historical alternative audio model from cdi-audio-completion.
// Retained for comparison; production uses cdiaudio.h and cdicdic_state.h.
// These models/tests are not a current silicon-fidelity certification.
