...
project("mametests")
	...
	files {
		...
		MAME_DIR .. "tests/emu/cpu/dsp56000_decode.cpp",
		MAME_DIR .. "tests/emu/cpu/dsp56000_wrap.cpp",
		MAME_DIR .. "tests/emu/machine/scc68070.cpp",
		MAME_DIR .. "tests/emu/machine/scc68070_peripherals.cpp",
		...
		MAME_DIR .. "tests/emu/philips/cdidvc_state_transitions.cpp",
